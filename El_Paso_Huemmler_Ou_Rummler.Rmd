...
data_folder <- "C:/Users/jtrum/Desktop/MUSA8010/data"
...
RT_stop_avg_5on <- RT_stop_avg[RT_stop_avg$avg_ons > 5, ]
RT_stop_avg_5off <- RT_stop_avg[RT_stop_avg$avg_offs > 5, ]
...
```{r ridership line type,  warning = FALSE, message = FALSE, results=FALSE}
ggplot(RT_avg_sum_st,
       aes(x=total_ons,
           y=total_offs,
           color=type,
           alpha=0.4))+
  geom_point(size=5)+
  labs(title="Total onboarding and offboarding per route",
       subtitle="Color indicates type of transit")+
  plotTheme
