...
transit_lines <- st_read("C:/Users/jtrum/pennmusa/MUSA8010/repository/data/transit_lines.geojson")
...
ggplot(dfRT_nogeom, aes(x = avg_ons, y = avg_offs)) +
  ...
  geom_abline(intecept=0, slope=1, color="#C96A52FF", alpha=0.3, size=1, style='dashed')+
  plotTheme
```
