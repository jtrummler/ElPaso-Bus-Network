...
general_points <- points_list$general
...
hex_vars <-
  hex_vars %>%
    mutate(
      schools.nn1 =
        nn_function(st_c(st_coid(hex_vars)), st_c(schools_hex),1),
      schools.nn3 =
        nn_function(st_c(st_coid(hex_vars)), st_c(schools_hex),3),
      schools.nn5 =
        nn_function(st_c(st_coid(hex_vars)), st_c(schools_hex),5),
      parks.nn1 =
        nn_function(st_c(st_coid(hex_vars)), st_c(st_coid(parks_hex)),1),
      parks.nn3 =
        nn_function(st_c(st_coid(hex_vars)), st_c(st_coid(parks_hex)),3),
      parks.nn5 =
        nn_function(st_c(st_coid(hex_vars)), st_c(st_coid(parks_hex)),5))
```
