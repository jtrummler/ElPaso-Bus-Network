...
To check out other practicum projects for the MUSA/Smart Cities practicum, click [here](https://pennmusa.github.io/MUSA_801.io/). To check out our web application, click [here](https://chuembucket.github.io/ElPaso-Bus-Network1/App/site/). To check our Github Pages, click [here](https://github.com/jtrummler/ElPaso-Bus-Network).
...
epworkincome <- hex_final[, c("uniqueID", "income1250LessPct", "income1251to3333Pct", "income3333OverPct")] %>% st_drop_geometry()

epworktidy <- epworkincome %>%
  gather(key = "IncomeLevel", value = "Income", -uniqueID)

ggplot(epworktidy, aes(x = Income, y = uniqueID, fill = IncomeLevel)) +
  ...
  labs(y = "Hex", x = "Income", fill = "Monthly Income ($)", title = "Job Income Breakdown at Hexbin Level",
       subtitle = "El Paso, TX",
       caption = "Data: LEHD, 2019") +
  plotTheme+
...
Distance to schools can serve as a potentially strong indicator of transit demand given high concentration of potential riders (students, teachers, staff), consistent travel patterns (circuitous), and \>INFO\<
...
Below is a point-level distribution of each feature, separated into four maps with shared characteristics. \>INFO\<
