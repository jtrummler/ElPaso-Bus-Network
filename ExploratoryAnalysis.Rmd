...
library(geojsonio)
destination <- geojson_read("../data/replica-city_of_el_paso-02_03_23-destination_layer.geojson",  what = "sp")
origin <- geojson_read("../data/replica-city_of_el_paso-02_03_23-origin_layer.geojson",  what = "sp")
```
...
library(ggplot2)
ggplot() +
  geom_polygon(data = destination_fortified, aes( x = long, y = lat, group = group), fill="#69b3a2", color="white") +
  theme_void() +
  labs(
...
ggplot() +
  geom_polygon(data = origin_fortified, aes( x = long, y = lat, group = group), fill="#69b3a2", color="white") +
  theme_void() +
  labs(
    title = "Origin layer",
    subtitle = "",
